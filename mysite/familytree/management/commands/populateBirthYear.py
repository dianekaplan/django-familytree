        ...
        for person in people:
            ...
            if not person.birthyear:
                ...
                if person.birthdate_note:
                    cleaned_value = person.birthdate_note.replace("?", "").replace("ish", "").replace("abt", "").replace("Abt.", "").replace(" ", "")
                    ...
                    if birthyear_as_int:
                        ...
                        print("This person has birthdate note but no birthyear saved: "+ this_display_name + ": "+ person.birthdate_note)